...
<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <div class="col-md-9">
            ...
            {!! Form::open(['class'=>'form','url'=>'receivegood','name'=>'myform'])!!}
    ...
    <div class="box-body bg-gray-active">
        ...
        <div class="container-fluid form-inline  margin-bottom margin">
            ...
            <div class="form-group col-md-4">
                {!! Form::label ('bil_dis_lbl','Receive No.:',['class' =>'control-label']) !!}

                {!! Form::text ('ReceiveNo','',['class'=>'input-sm','placeholder'=>'Settle No.','id'=>'GrNo','readonly']) !!}
            </div>
        ...
        <div class="row-fluid scrollbox">
            ...
            <table class="table table-responsive table-striped">
                ...
                <?php $count = 0 ?>
                {!! Form::open(['class'=>'form', 'url'=>'cleareceive' , 'method'=>'post']) !!}
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading"><h4><center>Please Enter an Receive Number to Proceed</center></h4></div>
                <div class="panel-body">
                    {!! Form::open(['class'=>'form', 'url'=>'savereceivedgoods' , 'method'=>'post']) !!}
                    <div class="form-inline ">
                        <div class="form-group">
                            {!! Form::label ('bil_dis_lbl','Receipt Numebr:',['class' =>'control-label']) !!}

                            {!! Form::text ('SaveNo','',['class'=>'input-sm','placeholder'=>'Receipt Number','onkeyup'=>'savereceived(this.value)','onchange'=>'savereceived(this.value)']) !!}
...
<script>
    ...
    function savereceived(str) {
        ...
        if (str.length == 0) {
            ...
            xmlhttp.open("GET", "savereceived/" + str, true);
            xmlhttp.send();
        }
    }
